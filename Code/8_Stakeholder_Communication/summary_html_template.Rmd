...
The following figures depict the range of each sampled parameter at this Assessment Unit. The actual sample values are overlayed onto the boxplots to provide an additional visualization of the spread. Samples originating from different Monitoring Locations are assigned different colors. 
...
The following figures depict the temporal range of parameter samples taken in this Assessment Unit. Samples originating from different Monitoring Locations are assigned different colors.
