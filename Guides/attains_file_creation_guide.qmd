...
The required packages for the *data_processing.R* code are [*tidyverse*](https://www.tidyverse.org/) and [*readxl*](https://cran.r-project.org/web/packages/readxl/index.html)*.* Installation for the *tidyverse* package can be found in the Data Pull Guide. Below is a code chunk that demonstrates how to install and load these packages.
